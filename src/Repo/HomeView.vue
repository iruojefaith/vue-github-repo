...
<template>
  <div class="home container mx-auto p-4 ">
    <div class="grid md:grid-cols-2 gap-6 my-3 ">
      <div class="card-one grid md:grid-cols-2 gap-3 bg-white rounded ">
        <img class=" rounded-full inline justify-self-center md:-ml-[2rem]  border-4 border-white/50 " :src="userData.avatar_url" alt="User Avatar" />
            ...
            <div class=" grid grid-cols-2 place-items-center ">
                  ...
                  <a class="rounded bg-green-400 p-2 mt-3 text-white text-xs text-center  " :href="userData.html_url" target="_blank">Visit GitHub Profile</a>
                </div>
          <div class="font-bold mt-6">
              <h3 class="text-[1.2rem] capitalize text-gray-600 text-center md:text-start "> Iruoje Faith Oluwafunmileyi </h3>
      ...
      <div class="card-two bg-white rounded capitalize text-gray-500 font-bold px-auto my-3 py-9 ">
